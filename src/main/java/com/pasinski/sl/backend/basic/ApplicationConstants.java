...
public class ApplicationConstants {
    ...
    public static final String DEFAULT_USER_IMAGE_URL_WITH_PARAMETER = DEFAULT_APP_URL + "/api/image/user?idUser=";
    public static final String DEFAULT_POST_IMAGE_URL_WITH_PARAMETER = DEFAULT_APP_URL + "/api/image/post?idPost=";
